...
//validate systems ability to handle multiple passangers in a single booking

@Listeners(resources.Listeners.class)
public class Goibibo_testcase_08 extends Launch_Quit
{
	...
	public void testCase_01(String source1, String destiny1, String destiny2, String date1, String month1, String date2 ,String month2, String pincode)
	{
		...
		summary.select_Multiple_Passangers();
		...
		summary.enter_details_for_multiple_passangers();
		summary.enter_email_id();
		summary.enter_mobile_no();
		
		summary.click_Submit_PB();
		Assert.assertTrue(summary.isAllTravellersDetailsEntered(), "travellers details are not entered");
		System.out.println("all traveller details are entered");
